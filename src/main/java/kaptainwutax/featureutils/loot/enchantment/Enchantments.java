...
public class Enchantments {
    ...
    public final static HashSet<String> ARMOR_HEAD = new HashSet<>(Arrays.asList("LEATHER_HELMET","GOLDEN_HELMET","DIAMOND_HELMET","ENCHANTED_BOOK", "BOOK"));
    public final static HashSet<String> ARMOR_CHEST = new HashSet<>(Arrays.asList("LEATHER_CHESTPLATE","GOLDEN_CHESTPLATE","DIAMOND_CHESTPLATE","ENCHANTED_BOOK", "BOOK"));
    public final static HashSet<String> ARMOR_FEET = new HashSet<>(Arrays.asList("LEATHER_BOOTS","GOLDEN_BOOTS","DIAMOND_BOOTS","ENCHANTED_BOOK", "BOOK"));
    public final static HashSet<String> ARMOR = new HashSet<>(Arrays.asList("LEATHER_HELMET","GOLDEN_HELMET","DIAMOND_HELMET","LEATHER_CHESTPLATE","GOLDEN_CHESTPLATE","DIAMOND_CHESTPLATE","LEATHER_LEGGINGS","GOLDEN_LEGGINGS","DIAMOND_LEGGINGS","LEATHER_BOOTS","GOLDEN_BOOTS","DIAMOND_BOOTS","ENCHANTED_BOOK", "BOOK"));
    public final static HashSet<String> BOW = new HashSet<>(Arrays.asList("BOW","ENCHANTED_BOOK", "BOOK"));
    public final static HashSet<String> BREAKABLE = new HashSet<>(Arrays.asList("ENCHANTED_BOOK", "BOOK","BOW","CROSSBOW","LEATHER_HELMET","GOLDEN_HELMET","DIAMOND_HELMET","LEATHER_CHESTPLATE","GOLDEN_CHESTPLATE","DIAMOND_CHESTPLATE","LEATHER_BOOTS","GOLDEN_BOOTS","DIAMOND_BOOTS","LEATHER_LEGGINGS","GOLDEN_LEGGINGS","DIAMOND_LEGGINGS","GOLDEN_SWORD","DIAMOND_SWORD","GOLDEN_AXE","DIAMOND_AXE","GOLDEN_HOE","DIAMOND_HOE","GOLDEN_PICKAXE","DIAMOND_PICKAXE","GOLDEN_SHOVEL","DIAMOND_SHOVEL"));
    ...
    public final static HashSet<String> WEARABLE = new HashSet<>(Arrays.asList("LEATHER_CHESTPLATE","GOLDEN_CHESTPLATE","DIAMOND_CHESTPLATE","LEATHER_LEGGINGS","GOLDEN_LEGGINGS","DIAMOND_LEGGINGS","LEATHER_BOOTS","GOLDEN_BOOTS","DIAMOND_BOOTS","LEATHER_HELMET","GOLDEN_HELMET","DIAMOND_HELMET","ENCHANTED_BOOK", "BOOK"));
    ...
    public final static HashSet<String> VANISHABLE = new HashSet<>(Arrays.asList("CROSSBOW","LEATHER_HELMET","GOLDEN_HELMET","DIAMOND_HELMET","LEATHER_CHESTPLATE","GOLDEN_CHESTPLATE","DIAMOND_CHESTPLATE","FISHING_ROD","GOLDEN_SHOVEL","DIAMOND_SHOVEL","GOLDEN_HOE","DIAMOND_HOE","TRIDENT","GOLDEN_SWORD","DIAMOND_SWORD","GOLDEN_PICKAXE","DIAMOND_PICKAXE","LEATHER_LEGGINGS","GOLDEN_LEGGINGS","DIAMOND_LEGGINGS","LEATHER_BOOTS","GOLDEN_BOOTS","DIAMOND_BOOTS","BOW","GOLDEN_AXE","DIAMOND_AXE","ENCHANTED_BOOK", "BOOK"));
