...
import static kaptainwutax.featureutils.loot.function.EnchantmentInstance.getRandomItem;
import static kaptainwutax.featureutils.loot.function.Enchantments.filterCompatibleEnchantments;
...
public class EnchantWithLevelsFunction implements LootFunction{
    ...
    public HashMap<String, Integer> enchantmentlist;
    ...
    public ItemStack enchantItem(LootContext random, ItemStack itemStack, int n, boolean bl, boolean b2) {
        ...
        for (EnchantmentInstance enchantmentInstance : list) {
            itemStack.getItem().setEnchantment(enchantmentInstance.getName());
            itemStack.getItem().setLevel(enchantmentInstance.getLevel());
        }
        return itemStack;
    }
