...
public class MCLootTables {
	...
	public static final LootTable BASTION_TREASURE_CHEST = new LootTable(
			new LootPool(new UniformRoll(1.0F, 2.0F),
					...
					new ItemEntry(Item.DIAMOND_SWORD, 10).apply(new EnchantRandomlyFunction()).apply(new ApplyDamageFunction()) /* set_damage */ ,
					new ItemEntry(Item.DIAMOND_CHESTPLATE, 6).apply(new EnchantRandomlyFunction()).apply(new ApplyDamageFunction()) /* set_damage */ ,
					new ItemEntry(Item.DIAMOND_HELMET, 6).apply(new EnchantRandomlyFunction()).apply(new ApplyDamageFunction()) /* set_damage */ ,
					new ItemEntry(Item.DIAMOND_LEGGINGS, 6).apply(new EnchantRandomlyFunction()).apply(new ApplyDamageFunction()) /* set_damage */ ,
					new ItemEntry(Item.DIAMOND_BOOTS, 6).apply(new EnchantRandomlyFunction()).apply(new ApplyDamageFunction()) /* set_damage */ ,
	...
	public static final LootTable RUINED_PORTAL_CHEST = new LootTable(
			new LootPool(new UniformRoll(4.0F, 8.0F),
					...
					new ItemEntry(Item.GOLDEN_SWORD, 15).apply(new EnchantRandomlyFunction()),
					new ItemEntry(Item.GOLDEN_AXE, 15).apply(new EnchantRandomlyFunction()),
					new ItemEntry(Item.GOLDEN_HOE, 15).apply(new EnchantRandomlyFunction()),
					new ItemEntry(Item.GOLDEN_SHOVEL, 15).apply(new EnchantRandomlyFunction()),
					new ItemEntry(Item.GOLDEN_PICKAXE, 15).apply(new EnchantRandomlyFunction()),
					new ItemEntry(Item.GOLDEN_BOOTS, 15).apply(new EnchantRandomlyFunction()),
					new ItemEntry(Item.GOLDEN_CHESTPLATE, 15).apply(new EnchantRandomlyFunction()),
					new ItemEntry(Item.GOLDEN_HELMET, 15).apply(new EnchantRandomlyFunction()),
					new ItemEntry(Item.GOLDEN_LEGGINGS, 15).apply(new EnchantRandomlyFunction()),
